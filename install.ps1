...
if ($BUILD) {
	$null = robocopy "$PSScriptRoot\Images" "$PSScriptRoot\SamplesOutput\Site\Content\Modules\KEDO\Images" /MIR
	$null = robocopy "$PSScriptRoot\Styles" "$PSScriptRoot\SamplesOutput\Site\Content\Modules\KEDO\Styles" /MIR
}
